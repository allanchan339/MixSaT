...
parser.add_argument('--model_name', required=False, type=str,
                    default="TwinsSVT_1d_group_LoGlo_bpv3", help='named of the model to save')
...
parser.add_argument('--project', default='SoccerViTAC',
                    type=str, help='project for wandb')
parser.add_argument('--entity', default='cihe-cis',
                    type=str, help='organization used in wandb')
parser.add_argument('--experiment_name', default='TwinsSVT_1d_group_LoGlo_bpConv_NMS6',
